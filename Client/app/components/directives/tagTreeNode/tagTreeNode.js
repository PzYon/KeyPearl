(function (app) {
    ...
    var TagTreeNodeDirective = function ($compile, tagTreeNodeTemplates, navigator, notifier, mobile) {
    ...
    TagTreeNodeDirective.$inject = ["$compile", "tagTreeNodeTemplates", "navigator", "notifier", "mobile"];
